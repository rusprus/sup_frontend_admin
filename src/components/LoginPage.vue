            ...
            <div class="mt-1">
              <input v-model="email" id="email" name="email" type="email" autocomplete="email" required=""
                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700"> Имя </label>
                        <div class="mt-1">
                            <input
                                v-model="name"
                                required=""
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-gray-500"> Или продолжить с</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 grid grid-cols-3 gap-3">
                        <div>
                            <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span class="sr-only">Войти с Facebook</span>
                        ...
                        <div>
                            <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span class="sr-only">Войти с Twitter</span>
                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                        ...
                        <div>
                            <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span class="sr-only">Войти с GitHub</span>
                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        fill-rule="evenodd"
...
export default {
    ...
    methods: {
        ...
        register() {
            // alert(this.login + this.password + this.name + this.email);
            try {
            //   alert('222')
                this.onRegister({
                    login: this.login,
        ...
        //     console.log(newVal)
        //     console.log(oldVal)
        //     if (newVal == UserRoles.Guest) {
        //       this.$router.push({ name: 'Admin' })
        //     }
        //   }
        // },
        // watchEffect(() => console.log(count.isAuthorized)),
