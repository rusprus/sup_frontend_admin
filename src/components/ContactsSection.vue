...
<template>
    <div class="max-w-7xl mx-auto py-24 px-4 bg-white sm:px-6 lg:px-8">
        ...
        <h2 class="text-3xl font-extrabold text-gray-900 sm:text-5xl sm:leading-none sm:tracking-tight lg:text-6xl">
            Контакты</h2>
        <p class="mt-6 max-w-2xl text-xl text-gray-500"> Для аренды позвоните ли напишите на мессенджер.</p>
        ...
        <div class="mt-24 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
            <div class="relative p-8 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col">
                <div class=" flex-1">
                    ...
                    <svg
                        class="w-24 h-24 text-green-400 fill-current" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path
            ...
            <div class="relative p-8 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col">
                <div class="cursor-pointer flex-1">
                    <!-- <h3 class="text-xl font-semibold text-gray-900"></h3> -->
                    <svg
                        class="w-24 h-24 text-gray-400 text-blue-400 fill-current" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 496 512">
                        <path
                    ...
                    <p class="mt-4 flex items-baseline text-gray-900">
                        <span class="text-5xl font-extrabold tracking-tight"></span>
                        <span class="ml-1 text-xl font-semibold">Telegramm</span>
                    </p>
                    <p class="mt-6 text-gray-500">89214835160</p>
