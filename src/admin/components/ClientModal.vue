                    ...
                    >
                        <div>
                            <form class="space-x-2 z-10">
                                <div>
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Добавление клиента</h3>
                                ...
                                <div class="space-x-2 z-10 grid md:grid-cols-1">
                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                        <label for="first-name" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> ФИО </label>
                                    ...
                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                        <label for="first-name" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> Телеграмм </label>
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <input
                                                type="text"
...
export default {
    ...
    methods: {
        ...mapActions(["addClient", "updateClient", "deleteClient", "toggleClientModal"]),
        close() {
