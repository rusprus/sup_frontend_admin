    ...
    <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
        <div>
          ...
          <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Лахтинский разлив
          </h3>
          <!-- <h3 class="text-3xl font-extrabold text-gray-900 sm:text-5xl sm:leading-none sm:tracking-tight lg:text-6xl">
            Лахтинский разлив</h3> -->
        </div>
      </div>
      <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        <div class="relative lg:row-start-1 lg:col-start-2">
          ...
          <div class="relative text-base mx-auto max-w-prose lg:max-w-none flex justify-end">
            <figure>
              <div class="aspect-w-12 aspect-h-7 lg:aspect-none max-h-fit object-none">
                ...
                <img class="rounded-lg shadow-lg object-cover object-center h-full w-full" src="@/assets/lahta.jpg" alt="Lahta"
                  />
        ...
        <div class="mt-8 lg:mt-0">
          ...
          <div class="mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
            <p>SUP-прогулка в акватории Лахтинского разлива.</p>
            <p>
              Мы полюбуемся пейзажами Лахтинского Разлива, на зеленые берега, заросли тростника и кувшинок. Встретим
              один из самых красивых закатов в городе на фоне урбанистического пейзажа.
            </p>
            <p>Маршрут легкий, отлично подойдет для начинающих. Прогулка длится 1,5 - 2 часа
              Сделаем красивые фотографии на фоне заката)</p>
